        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-full">
          ...
          <div className="lg:col-span-2 bg-white/5 border border-white/10 rounded-lg p-4">
            ...
            <div className="mt-4 flex justify-center gap-2">
              <button className="p-2 bg-white/10 hover:bg-white/20 border border-white/20 rounded text-white text-sm">🔄</button>
              <button className="p-2 bg-white/10 hover:bg-white/20 border border-white/20 rounded text-white text-sm">🔍</button>
              <button className="p-2 bg-white/10 hover:bg-white/20 border border-white/20 rounded text-white text-sm">📐</button>
            </div>
          </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-4">
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <button className="p-2 bg-yellow-600/20 hover:bg-yellow-600/30 border border-yellow-500/30 rounded text-yellow-300 text-xs">☀️ Day</button>
                  <button className="p-2 bg-blue-600/20 hover:bg-blue-600/30 border border-blue-500/30 rounded text-blue-300 text-xs">🌙 Night</button>
                </div>
              </div>
            </div>
          </div>
