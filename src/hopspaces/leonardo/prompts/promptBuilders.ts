...
// COVER IMAGE PROMPT
// -----------------------------
export function buildCoverPrompt(name: string, type: HopSpaceType, mood: HopSpaceMood): string {
  return `
...
// ANIMA AVATAR PROMPT
// -----------------------------
export function buildAnimaAvatarPrompt(name: string, mood: HopSpaceMood): string {
  return `
...
// MOODBOARD PROMPT
// -----------------------------
export function buildMoodboardPrompt(name: string, type: HopSpaceType, mood: HopSpaceMood): string {
  return `
