    ...
    <>
      ...
      >
        <div className="relative shrink-0">
          <div
            className={`w-12 h-12 rounded-full flex items-center justify-center text-xl ${isActive ? 'bg-[#53C8FF] text-[#0A0F1F]' : 'bg-white/10 text-white'}`}
          >
        ...
        <div className="flex-1 min-w-0 text-left">
          <div className="flex items-center justify-between mb-0.5">
            <span
              className={`text-sm font-bold truncate ${isActive ? 'text-[#53C8FF]' : 'text-white'}`}
            >
              {chat.title || 'Untitled'}
            </span>
          </div>
