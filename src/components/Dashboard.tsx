      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
            <div className="bg-[#0E1430] border border-white/5 rounded-[28px] p-7 shadow-2xl relative overflow-hidden group">
              ...
              <h3 className="text-[10px] font-black uppercase tracking-[0.3em] text-[#53C8FF] mb-8 opacity-60 italic">Welcome to CloudHop</h3>
              
              <div className="text-center py-16">
                <div className="text-6xl mb-6">🌌</div>
                <h2 className="text-2xl font-bold text-white mb-4">Your Emotional Universe Awaits</h2>
                <p className="text-white/60 max-w-md mx-auto mb-8">
                  Navigate to HopHub to connect with others, or explore Spaces to create and collaborate.
                </p>
        ...
        <div className="space-y-8">
          <div className="bg-[#0E1430] border border-white/5 rounded-[28px] p-7 shadow-2xl relative overflow-hidden group">
            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-[#53C8FF]/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
            <h3 className="text-[10px] font-black uppercase tracking-[0.3em] text-[#53C8FF] mb-8 opacity-60 italic">Space Schedule</h3>
          ...
          <div className="bg-[#0E1430] border border-white/5 rounded-[28px] p-7 shadow-2xl relative overflow-hidden group">
            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-[#53C8FF]/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
            <h3 className="text-[10px] font-black uppercase tracking-[0.3em] text-[#53C8FF] mb-8 opacity-60 italic">Cloud Insights</h3>
            ...
            <div className="space-y-4">
               ...
               <div className="p-5 bg-[#1A2348]/30 rounded-2xl border border-[#53C8FF]/10 italic">
                  <p className="text-[10px] text-white/70 leading-relaxed font-medium">Your workspace is ready. Navigate to HopHub to connect with your community.</p>
               </div>
            </div>
          </div>
        </div>
