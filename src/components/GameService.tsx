      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex justify-center mb-8">
            <GameServiceGlyph size={120} className="hover:scale-110 transition-transform duration-500" />
          </div>
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Your gateway to infinite gaming realms across all platforms. 
            Launch, manage, and explore games from Epic, Steam, Xbox, PlayStation, Nintendo, and more.
          </p>
        </div>
