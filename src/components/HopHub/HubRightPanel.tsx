...
export const HubRightPanel: React.FC<HubRightPanelProps> = ({
  ...
  const renderContent = () => {
    ...
    // If in spaces mode and a space is selected, show space context
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-white/60 text-xs capitalize">{selectedSpace.type.replace('_', ' ')}</div>
                </div>
              </div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-lg p-4">
            ...
            <div className="space-y-3">
              <div className="text-white/80 text-xs">
                {selectedSpace.type === 'music' && "I'm your AI music composer. I can help you create melodies, harmonies, and rhythms."}
                {selectedSpace.type === 'fluid_art' && "I'm your AI art assistant. I can suggest color palettes, brush techniques, and creative ideas."}
                {selectedSpace.type === 'ideas' && "I'm your AI brainstorming partner. I can help organize thoughts and generate new concepts."}
                {selectedSpace.type === 'world' && "I'm your AI world builder. I can help design environments, scenes, and 3D spaces."}
                {selectedSpace.type === 'anima' && "I'm your AI spiritual guide. I can help with symbolic interpretations and ritual design."}
              </div>
    ...
    switch (activeTab) {
      ...
      case 'groups':
        return (
          <div className="p-4 space-y-4">
            <div className="bg-white/5 border border-white/10 rounded-lg p-4">
              <h3 className="text-white font-medium mb-3">Group Info</h3>
              <div className="space-y-2">
                <div className="text-white/80 text-sm">Group details and settings will appear here</div>
              </div>
            </div>
          </div>
        );
      ...
      case 'channels':
        return (
          <div className="p-4 space-y-4">
            <div className="bg-white/5 border border-white/10 rounded-lg p-4">
              <h3 className="text-white font-medium mb-3">Channel Info</h3>
              <div className="space-y-2">
                <div className="text-white/80 text-sm">Channel details and topic will appear here</div>
              </div>
            </div>
          </div>
        );
  ...
  return (
    <div
      ref={rightPanelRef}
      className="w-80 bg-[#0a0d1f] border-l border-white/10 flex flex-col"
    >
      {renderContent()}
    </div>
  );
