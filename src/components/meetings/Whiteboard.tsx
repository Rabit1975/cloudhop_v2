    ...
    <div className="fixed inset-0 z-50 bg-black/80 flex flex-col">
      <div className="glass-panel flex items-center justify-between px-6 py-3 border-b border-cyan-400/20">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={clearCanvas}
            className="p-2 rounded text-muted-foreground hover:text-red-400 transition-all"
          >
            <Trash2 className="w-4 h-4" />
          </button>
          <button
            onClick={onClose}
            className="p-2 rounded text-muted-foreground hover:text-foreground transition-all"
          >
            <X className="w-4 h-4" />
          </button>
        </div>
