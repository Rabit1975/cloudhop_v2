...
const BACKGROUNDS = [
  ...
  },
  {
    ...
    name: 'Aurora',
    preview: '🌈',
    gradient: 'linear-gradient(135deg, #00d2ff, #3a7bd5, #ff6bcd)',
  },
  {
    id: 'cloudhop',
    name: 'CloudHop',
    preview: '☁️',
    gradient: 'linear-gradient(135deg, #0ea5e9, #d946ef, #0ea5e9)',
  },
  {
    id: 'sunset',
    name: 'Sunset',
...
export default function VirtualBackgrounds({
  ...
  return (
    <div className="glass-panel rounded-xl border-cyan-400/30 p-4">
      ...
      >
        <div className="w-16 h-16 rounded-full bg-gradient-to-br from-cyan-500 to-magenta-500 flex items-center justify-center text-white font-bold text-xl">
          U
        </div>
      </div>
