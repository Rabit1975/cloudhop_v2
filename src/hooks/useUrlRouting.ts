...
const mapPathToView = (path: string): View => {
  switch (path) {
    case '/': return View.SPECTRUM;
    case '/dashboard': return View.DASHBOARD;
    case '/chat': return View.CHAT;
    case '/meetings': return View.MEETINGS;
    case '/spaces': return View.CORE;
    case '/arcade': return View.ARCADE;
    case '/profile': return View.PROFILE;
    case '/settings': return View.SETTINGS;
    case '/ai-tools': return View.AI_TOOLS;
    case '/auth': return View.AUTH;
    default: return View.SPECTRUM;
  }
};

const mapViewToPath = (view: View): string => {
  switch (view) {
    case View.SPECTRUM: return '/';
    ...
    case View.AI_TOOLS: return '/ai-tools';
    case View.AUTH: return '/auth';
    default: return '/';
  }
};
