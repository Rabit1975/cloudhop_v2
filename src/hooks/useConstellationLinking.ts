...
export function useConstellationLinking(
  ...
  useEffect(() => {
    ...
    const color = archetypeColors[primaryTag as keyof typeof archetypeColors] || archetypeColors.default;
...
function generateNodePositions(centerX: number, centerY: number, count: number, radius: number = 180): ConstellationNode[] {
