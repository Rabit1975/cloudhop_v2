...
export default function RabbitAI({
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full h-full rounded-full bg-gradient-to-br from-cyan-400 to-magenta-400 border-2 border-cyan-400/60 shadow-lg shadow-cyan-400/40 flex items-center justify-center">
