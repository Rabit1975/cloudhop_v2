...
export default function Chat({ userId: userIdProp, activeTab = 'hophub' }: ChatProps) {
  ...
  useEffect(() => {
    setMessages([
      ...
      {
        id: '2',
        content: 'This is the main chat interface',
        sender_id: 'CloudRabbit',
        chat_id: 'general-chat',
              ...
              <>
                  ...
                  <div className="space-y-2">
                    <div 
                      className={`flex items-center gap-3 p-2 rounded-lg cursor-pointer transition-colors ${
                        selectedGroup === 'general-lobby' ? 'bg-white/10' : 'hover:bg-white/5'
                      }`}
                      onClick={() => {
                        setSelectedGroup('general-lobby');
                        setSelectedChatId('general-chat');
                      }}
                    >
                    ...
                    <div 
                      className={`flex items-center gap-3 p-2 rounded-lg cursor-pointer transition-colors ${
                        selectedGroup === 'dev-team' ? 'bg-white/10' : 'hover:bg-white/5'
                      }`}
                      onClick={() => {
                        setSelectedGroup('dev-team');
                        setSelectedChatId('dev-chat');
                      }}
                    >
                      ...
                      <div className="flex-1">
                        <div className="text-white font-medium text-sm">Dev Team</div>
                        <div className="text-gray-400 text-xs">Development • 8 members</div>
                      </div>
                      <div className="text-gray-400 text-xs">1:30 PM</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4 border-t border-white/5">
                  ...
                  <div className="space-y-2">
                    <div 
                      className={`flex items-center gap-3 p-2 rounded-lg cursor-pointer transition-colors ${
                        selectedChatId === 'general-channel' ? 'bg-white/10' : 'hover:bg-white/5'
                      }`}
                      onClick={() => {
                        setSelectedChatId('general-channel');
                    ...
                    <div 
                      className={`flex items-center gap-3 p-2 rounded-lg cursor-pointer transition-colors ${
                        selectedChatId === 'random-channel' ? 'bg-white/10' : 'hover:bg-white/5'
                      }`}
                      onClick={() => {
                        setSelectedChatId('random-channel');
                        setSelectedGroup(null);
                      }}
                    >
                      ...
                      <div className="flex-1">
                        <div className="text-white font-medium text-sm">#random</div>
                        <div className="text-gray-400 text-xs">Random conversations</div>
                      </div>
                    </div>
                  </div>
                </div>
