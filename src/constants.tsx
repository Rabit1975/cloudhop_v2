...
export const CloudHopLogo: React.FC<{
  ...
  const renderLogo = () => {
    switch (variant) {
      case 'q1':
        return <LogoQ1 className={className} style={style} />;
      case 'q2':
        return <LogoQ2 className={className} style={style} />;
      case 'q3':
        return <LogoQ3 className={className} style={style} />;
      case 'q4':
        return <LogoQ4 className={className} style={style} />;
      case '3d':
        return <Logo3D className={className} style={style} />;
      case 'glow':
        return <LogoGlow className={className} style={style} />;
      case 'neon':
        return <LogoGlow className={className} style={style} />;
      case 'main':
      case 'white':
      default:
        return <LogoMain className={className} style={style} />;
    }
  };
