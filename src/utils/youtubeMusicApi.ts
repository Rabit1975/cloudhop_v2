    ...
    try {
      ...
      const response = await fetch('https://music.youtube.com/youtubei/v1/browse?prettyPrint=false', {
        ...
        headers: {
          ...
          'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/144.0.0.0 Safari/537.36',
          'X-Goog-Authuser': '0',
          'X-Goog-Visitor-Id': 'CgtTY0ZGV1VZLVQtMCjOh_%3D%3D',
          'X-YouTube-Client-Name': '67',
          'X-YouTube-Client-Version': '1.20260128.03.00',
          'X-YouTube-Device': 'cbr=Chrome&cbrver=144.0.0.0&ceng=WebKit&cengver=537.36&cos=Windows&cosver=10.0&cplatform=DESKTOP',
      ...
      if (error instanceof TypeError && error.message.includes('Failed to fetch')) {
        throw new Error('CORS error: YouTube Music blocks cross-origin requests. This method may not work from a web app.');
      }
