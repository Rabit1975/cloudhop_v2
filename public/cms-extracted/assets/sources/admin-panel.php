...
if (!$result) {
	die('MYSQL ERROR: ' . $GameMonetizeConnect->error);
		...
		$currentProvider = !empty($get_chatgpt['llm_provider']) ? $get_chatgpt['llm_provider'] : 'openai';
		$currentModel = !empty($get_chatgpt['chatgpt_model']) ? $get_chatgpt['chatgpt_model'] : 'gpt-4o-mini';
