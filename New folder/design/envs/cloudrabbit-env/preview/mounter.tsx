 ...
 */
export function CloudrabbitProvider({ children }: { children: React.ReactNode }) {
  return <CloudrabbitTheme>{children}</CloudrabbitTheme>;
}
 ...
 */
export default createMounter(CloudrabbitProvider) as any;