-- Migration: Fix Chat Participants Recursion (Final)
-- Description: This migration resolves the infinite recursion in RLS policies for chats and chat_participants.
