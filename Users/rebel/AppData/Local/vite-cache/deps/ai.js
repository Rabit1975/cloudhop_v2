...
var require_get_context = __commonJS({
  "node_modules/@vercel/oidc/dist/get-context.js"(exports, module) {
    ...
    function getContext3() {
      ...
      return ((_b8 = (_a16 = fromSymbol[SYMBOL_FOR_REQ_CONTEXT]) == null ? void 0 : _a16.get) == null ? void 0 : _b8.call(_a16)) ?? {};
    }
  }
});
...
var BaggageImpl = (
  ...
  (function() {
    ...
    BaggageImpl2.prototype.getAllEntries = function() {
      return Array.from(this._entries.entries()).map(function(_a16) {
        var _b8 = __read3(_a16, 2), k = _b8[0], v = _b8[1];
        return [k, v];
      });
    };
    ...
    BaggageImpl2.prototype.removeEntries = function() {
      ...
      try {
        ...
        try {
          if (keys_1_1 && !keys_1_1.done && (_a16 = keys_1.return)) _a16.call(keys_1);
        } finally {
...
var ContextAPI = (
  ...
  (function() {
    ...
    ContextAPI2.prototype.with = function(context2, fn, thisArg) {
      ...
      return (_a16 = this._getContextManager()).with.apply(_a16, __spreadArray4([context2, fn, thisArg], __read5(args), false));
    };
...
function getSpanContext(context2) {
  var _a16;
  return (_a16 = getSpan(context2)) === null || _a16 === void 0 ? void 0 : _a16.spanContext();
}
...
var name7 = "AI_InvalidArgumentError";
...
function resolveTranscriptionModel(model) {
  ...
  return (_b8 = (_a16 = getGlobalProvider()).transcriptionModel) == null ? void 0 : _b8.call(_a16, model);
}
function resolveSpeechModel(model) {
  ...
  return (_b8 = (_a16 = getGlobalProvider()).speechModel) == null ? void 0 : _b8.call(_a16, model);
}
...
var VERSION3 = true ? "6.0.6" : "0.0.0-test";
  ...
  return {
    ...
    inputTokenDetails: {
      noCacheTokens: addTokenCounts(
        ...
        (_b8 = usage2.inputTokenDetails) == null ? void 0 : _b8.noCacheTokens
      ),
...
function hasToolCall(toolName) {
  return ({ steps }) => {
    var _a16, _b8, _c;
    return (_c = (_b8 = (_a16 = steps[steps.length - 1]) == null ? void 0 : _a16.toolCalls) == null ? void 0 : _b8.some(
...
var ToolLoopAgent = class {
  ...
  async prepareCall(options) {
    ...
    const preparedCallArgs = (_d = await ((_c = (_b8 = this.settings).prepareCall) == null ? void 0 : _c.call(_b8, baseCallArgs))) != null ? _d : baseCallArgs;
        ...
        const generateResult = await retry(
          () => recordSpan({
            ...
            fn: async (span2) => {
              ...
              const responseData = {
                id: (_b8 = (_a17 = result2.response) == null ? void 0 : _a17.id) != null ? _b8 : generateId2(),
...
var DefaultProviderRegistry = class {
  ...
  languageModel(id) {
    ...
    let model = (_b8 = (_a16 = this.getProvider(providerId, "languageModel")).languageModel) == null ? void 0 : _b8.call(
      _a16,
      modelId
    );
    if (model == null) {
    ...
    fn: async () => {
      ...
      return new DefaultRerankResult({
        ...
        response: {
          ...
          modelId: (_b8 = response == null ? void 0 : response.modelId) != null ? _b8 : model.modelId,
          headers: response == null ? void 0 : response.headers,
